...
filtered_dataframe, selected_continent, selected_country, selected_year_range = sidebar.filtering(merged_dataframe)

src.pages.data_exploration.page(
    [merged_dataframe], [filtered_dataframe], selected_continent, selected_country, selected_year_range, target_column
)
